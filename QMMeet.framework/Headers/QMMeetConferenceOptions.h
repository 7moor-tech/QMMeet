...
#import "QMMeetUserInfo.h"


@interface QMMeetConferenceOptionsBuilder : NSObject
...
false：会切换
*/
@property (nonatomic, assign) BOOL disableSimulcast;
 ...
 */
@property (nonatomic, nullable) QMMeetUserInfo *userInfo;
...
@interface QMMeetConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(QMMeetConferenceOptionsBuilder *_Nonnull))initBlock;
