...
@protocol QMMeetViewDelegate <NSObject>
...
- (void)conferenceWillJoinWithPwd:(NSDictionary *)data;
 ...
 * associated `QMMeetView`. The latter will automatically detect its new size
