...
#import "QMMeetConferenceOptions.h"
#import "QMMeetViewDelegate.h"

@interface QMMeetView : UIView

@property (nonatomic, nullable, weak) id<QMMeetViewDelegate> delegate;
 ...
 * joining the new one.
 */
- (void)join:(QMMeetConferenceOptions *_Nullable)options;
/**
